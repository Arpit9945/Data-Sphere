import './Header.scss';
import { white_logo } from '../../Images/logo';
...
const Header_menu = () => {
    ...
    return (
        <div className='ds-navigaion-menu'>
            <div className='ds-navigation-logo'>
                <span className={`${'datasphere' === menu ? 'ds-nav-logo active' : 'ds-nav-logo '}`} onClick={(e) => { Show_menu(e) }}>
                    {white_logo}
                </span>
                {
